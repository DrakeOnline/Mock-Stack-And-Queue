...
class Carmen(Queue):
    ...
    """
    A method to test the finding time of one hundred elements
    """
    ...
    """
    A method to test the finding time of one thousand elements
    """
